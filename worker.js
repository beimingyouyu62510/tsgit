...
let 哎呀呀这是我的VL密钥 = "1acc3cc2-26d8-4284-8cad-082d3dc46649"; //这是真实的UUID，通用订阅会进行验证，建议修改为自己的规范化UUID
...
let 我的优选 = ['yx.jisucf.cloudns.biz'
  //'www.visa.com',
] //'yx.jisucf.cloudns.biz',
...
let 反代IP = 'git.jisucf.cloudns.ch' //反代IP或域名，反代IP端口一般情况下不用填写，如果你非要用非标反代的话，可以填'ts.hpc.tw:443'这样
...
let 我的节点名字 = 'TS-git' //自己的节点名字【统一名称】

let 伪装网页 = 'https://www.imdb.com/chart/tvmeter/' //填入伪装网页，格式'www.youku.com'，建议用小站伪装，比较靠谱
//////////////////////////////////////////////////////////////////////////网页入口////////////////////////////////////////////////////////////////////////
export default {
