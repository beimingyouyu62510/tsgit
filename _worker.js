...
let 哎呀呀这是我的VL密钥 = "aa6afb24-210c-4fdc-979e-58f71a6f779f"; //建议更改为自己的标准化UUID

let 启用反代功能 = true //选择是否启用反代功能【总开关】，false，true，现在你可以自由的选择是否启用反代功能了
let 反代IP = '45.62.119.89:51443' //反代IP或域名，反代IP端口一般情况下不用填写，如果你非要用非标反代的话，可以填'ts.hpc.tw:443'这样
...
////////////////////////////////////////////////////////////////////////动态负载配置//////////////////////////////////////////////////////////////////////
let 启用动态负载 = false //个人自用模式，适合日常【单脚本部署】，优点是轻度使用【油管4K】worker几乎不会超时，缺点是带宽低以及所有依赖单线程的都废了【浏览器单线程下载拉起速度快还是可以很稳的】，适合看看油管TV刷刷手机啥的不错，这个模式只适合个人单应用场景，不适合测速玩和高频下载【照样超时】
let 最大目标带宽 = 20 //单位M，允许的最大带宽【单线程理论值】，并发不受影响
let 启用主动断开 = false //主动断开逻辑，可以降低长连接压力
...
let 转发地址 = [
    ...
    "three04.chenmo62512.workers.dev"  //'www.111.com', //示例
];
//////////////////////////////////////////////////////////////////////////DOH配置/////////////////////////////////////////////////////////////////////////
